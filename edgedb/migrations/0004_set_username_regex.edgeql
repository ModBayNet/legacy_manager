UPDATE User
FILTER NOT re_test(r'[a-zA-Z_]\w{4,11}', .username)
SET {
    username := (<str>.id)[:12]
};


CREATE MIGRATION set_username_regex TO {
    module default {
        type DB {
        ...
        type User {
            required property username -> str {
                ...
                constraint regexp(r'[a-zA-Z_]\w{4,11}')
            };
...
COMMIT MIGRATION set_username_regex;
